...
import { getUsers, getUser, getFriends } from '@/lib/api';
      ...
      <main className="home-main">
        ...
        <aside className="home-sidebar-right">
          ...
          <div className="home-quick-links">
            <h3>바로가기</h3>
            <button onClick={() => router.push(`/${myUsername}/diary`)}>내 다이어리</button>
            <button onClick={() => router.push(`/${myUsername}/photo`)}>내 사진첩</button>
            <button onClick={() => router.push(`/${myUsername}/office`)}>내 사무실</button>
          </div>
        </aside>
      </main>
