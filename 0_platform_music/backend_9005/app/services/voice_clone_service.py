...
async def submit_verify(clone_id: str, verify_object_name: str, singer_skill_level: int) -> dict:
    ...
    body = {
        ...
        "singerSkillLevel": int(singer_skill_level),
    ...
    await mongo[VOICE_CLONES_COLLECTION].update_one(
        ...
        {"$set": {
            ...
            "singer_skill_level": int(singer_skill_level),
