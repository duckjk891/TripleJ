...
export const CONTENT_OPTIONS = ['사랑', '이별', '짝사랑', '우정', '성장·자기계발', '자유·일탈', '희망·꿈', '외로움·그리움', '일상의 소소함', '청춘·방황'];
export const KEYWORD_OPTIONS = ['봄', '여름', '가을', '겨울', '바다', '별·밤하늘', '도시·야경', '꿈', '추억·기억', '비·눈', '카페·일상', '여행·길'];
